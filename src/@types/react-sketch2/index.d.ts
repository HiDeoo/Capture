/**
 * Imported & modified from the fork of react-sketch used which didn't modify the typings properly.
 * The initial typings are also incomplete.
 * @see https://github.com/x5engine/react-sketch/blob/master/types/index.d.ts
 */
declare module 'react-sketch2' {
  ...
  export class SketchField extends React.PureComponent<{
    ...
    onChange?: (evt: Optional<React.MouseEvent>) => void
     ...
     */
    toJSON(propertiesToInclude?: ArrayLike<string>): { background: string; objects: unknown[]; version: string }
